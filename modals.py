    ...
    def compose(self) -> ComposeResult:
        with Container(classes="modal-box"):
            yield Static(
                ...
                "  [bold]g[/] grab / place token   [bold]n[/] next turn\n"
                ...
                "  [bold]shift+m[/]/[bold]b[/] monster library (SRD)   [bold]v[/] spellbook   [bold]r[/] roll init\n"
                ...
                "  [bold]/[/] chat with DM assistant   [bold]Esc[/] drop token / cancel   [bold]?[/] help\n"
